%! TEX program = xelatex
\documentclass[9pt,oneside,mpar,cn,nclassical]{manuscript}
...
\begin{document}
    ...
    \begin{tcolorbox}[enhanced jigsaw,colback=lightorange!20,frame hidden]
    ...
    \section{数学环境}\subtitle{定理、定义、注记、猜想、例子……}
        ...
        \begin{theorem}[定理名称] 
            定理的内容.\marginnote{\normalfont\small environment: \ttfamily theorem}
        \end{theorem}
        \begin{definition}[定义对象]
            具体的定义.\marginnote{\normalfont\small environment: \ttfamily definition}
        \end{definition}
        \vspace{-0.25\baselineskip}
        \begin{remark}
            一些说明文字.\marginnote{\normalfont\small environment: \ttfamily remark}
        \end{remark}
        \vspace{-0.25\baselineskip}
        \begin{conjecture}[猜想描述]
            具体的内容.\marginnote{\normalfont\small environment: \ttfamily conjecture}
        \end{conjecture}
        \begin{example}
            一个例子.\marginnote{\normalfont\small environment: \ttfamily example}
        \end{example}
